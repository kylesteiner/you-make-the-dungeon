package entities {
    ...
    public class EntityFactory {
        ...
        public function constructArcher(x:int=0, y:int=0):Enemy {
            ...
            return new Enemy(x, y, Util.ENEMY_ARCHER, Assets.textures[Util.ENEMY_ARCHER], hp, atk, reward);
        }
        ...
        public function constructNinja(x:int=0, y:int=0):Enemy {
            ...
            return new Enemy(x, y, Util.ENEMY_NINJA, Assets.textures[Util.ENEMY_NINJA], hp, atk, reward);
        }
